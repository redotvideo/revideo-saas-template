    ...
    <>
      ...
      <main className="flex items-center flex-col mx-auto justify-center mt-48 p-24 text-center max-w-4xl">
        ...
        <Link href="/create">
          <button
            type="button"
            className="rounded-full bg-gray-700 mt-8 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Create a Video
          </button>
        </Link>
